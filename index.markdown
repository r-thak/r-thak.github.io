...
<div class="home-landing">
  <nav class="home-nav-landing">
    <a href="{{ '/about' | relative_url }}" class="home-link-landing">About</a>
    <a href="{{ '/projects' | relative_url }}" class="home-link-landing">Projects</a>
    <a href="{{ '/blog' | relative_url }}" class="home-link-landing">Blog</a>
  </nav>

  <footer class="home-footer-landing">
    <div class="contact-links-small">
      <a href="mailto:mail@rthak.com">
      ...
      <span>•</span>
      <a href="https://linkedin.com/in/rthak" target="_blank">
      ...
      <span>•</span>
      <a href="https://github.com/r-thak" target="_blank">
      ...
      <span>•</span>
      <a href="https://instagram.com/rohanthakkar_" target="_blank">
      ...
      <span>•</span>
      <a href="https://discord.com/users/rt552" target="_blank">
